...
namespace MatrixSharp.Entities.Events
{
	...
	public class RoomEvent : Event
	{
		...
		public RoomEvent(object content, string type, string eventId, string sender, int originServerTs, string roomId) : base(content, type)
		{
			EventId = eventId;
			Sender = sender;
		...
		public int OriginServerTs { get;  }

		/// <inheritdoc cref="RoomEventUnsignedData"/>
		[JsonPropertyName("unsigned")]
		public RoomEventUnsignedData? UnsignedData { get; set; }
		...
		/// </summary>
		public class RoomEventUnsignedData
		{
			/// <summary>
