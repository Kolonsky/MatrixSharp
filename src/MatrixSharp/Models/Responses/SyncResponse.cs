...
namespace MatrixSharp.Models.Responses
{
	...
	public class SyncResponse
	{
		...
		// TODO: device_one_time_keys_count
		...
		public Presence? PresenceUpdates { get; set; }

		/// <inheritdoc cref="Rooms" />
		[JsonPropertyName("rooms")]
		public Rooms? RoomsUpdates { get; set; }
		...
		public class Rooms
		{
			...
			public class InvitedRoom
			{
				...
				///     <see cref="StrippedState.Sender" />, <see cref="Type" />, <see cref="StrippedState.StateKey" /> and
			...
			public class JoinedRoom
			{
				...
				public Timeline? RoomTimeline { get; set; }
			...
			{
				/// <inheritdoc cref="KnockState" />
				[JsonPropertyName("knock_state")]
				public KnockState? RoomKnockState { get; set; }

				#region Models

				/// <summary>
				///     The state of a room that the user has knocked upon. The state events contained here have the same restrictions as
				///     <see cref="InviteState" />.
				/// </summary>
			...
			public class Timeline
			{
				...
				/// </summary>
				[JsonPropertyName("events")]
				public RoomEvent[]? SyncRoomEvents { get; set; }
			...
			{
				/// <inheritdoc cref="MatrixSharp.Models.Responses.SyncResponse.Rooms.StrippedState" />
