...
namespace MatrixSharp.Api.EventSchemas.Schema
{
	...
	public record RoomPowerLevels : StateEvent<RoomPowerLevels.ContentProperty>
	{
		private const string TYPE = "m.room.power_levels";

		/// <inheritdoc cref="RoomPowerLevels" />
		/// <param name="stateKey"> A zero-length string.</param>
		public RoomPowerLevels(ContentProperty content, string eventId, string sender, long originServerTs,
		...
		public record ContentProperty : IContentProperty
		{
			...
			///     unspecified.
			/// </summary>
			public int? UserDefault { get; init; }

			/// <inheritdoc cref="NotificationsPowerLevel" />
			public NotificationsPowerLevel? Notifications { get; init; }

			/// <summary>
			///     The power level requirements for specific notification types.
			///     This is a mapping from ``key`` to power level for that notifications key.
			/// </summary>
			public record NotificationsPowerLevel
			{
				/// <summary>
				...
				[JsonExtensionData] public IDictionary<string, JsonElement>? AdditionalProperties;
			}
		}
	}
}