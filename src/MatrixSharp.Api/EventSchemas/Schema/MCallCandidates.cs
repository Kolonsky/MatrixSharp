...
{
	/// <inheritdoc cref="CallCandidatesEventContent" />
	[MatrixEventType("m.call.candidates")]
	public record CallCandidatesEvent : RoomEvent<CallCandidatesEventContent>
	{
		/// <inheritdoc cref="CallCandidatesEvent" />
		public CallCandidatesEvent(CallCandidatesEventContent content, string type, string eventId, string sender,
	...
	public record CallCandidatesEventContent(
		string CallId,
