...
{
	/// <inheritdoc cref="DirectEventContent" />
	[MatrixEventType("m.direct")]
	public record DirectEvent : Event<DirectEventContent>
	{
		/// <inheritdoc cref="DirectEvent" />
		public DirectEvent(DirectEventContent content, string type) : base(content, type)
		{
		}
	}
	...
	///     that user ID.
	/// </summary>
	public record DirectEventContent : IEventContent
	{
