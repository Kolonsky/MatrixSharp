...
{
	/// <inheritdoc cref="RoomKeyEventContent" />
	[MatrixEventType("m.room_key")]
	public record RoomKeyEvent : Event<RoomKeyEventContent>
	{
		/// <inheritdoc cref="RoomKeyEvent" />
		public RoomKeyEvent(RoomKeyEventContent content, string type) : base(content, type)
		{
		}
	}
	...
	public record RoomKeyEventContent(
		RoomKeyEventContent.AlgorithmEnum Algorithm,
		string RoomId,
		string SessionId,
		string SessionKey
	) : IEventContent
